...
#
# Script generated by Vivado on Wed May 28 04:32:52 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bram_pcie_cfgspace.sh
...
#
# Usage        : bram_pcie_cfgspace.sh
#                bram_pcie_cfgspace.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_pcie_cfgspace.sh [-reset_run]
#                bram_pcie_cfgspace.sh [-reset_log]
#                bram_pcie_cfgspace.sh [-help]
#
...
# script info
echo -e "bram_pcie_cfgspace.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_pcie_cfgspace.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bram_pcie_cfgspace xil_defaultlib.bram_pcie_cfgspace xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bram_pcie_cfgspace -key {Behavioral:sim_1:Functional:bram_pcie_cfgspace} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bram_pcie_cfgspace.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bram_pcie_cfgspace.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bram_pcie_cfgspace.sh [-help]\n\
Usage: bram_pcie_cfgspace.sh [-step]\n\
Usage: bram_pcie_cfgspace.sh [-lib_map_path]\n\
Usage: bram_pcie_cfgspace.sh [-reset_run]\n\
Usage: bram_pcie_cfgspace.sh [-reset_log]\n\
Usage: bram_pcie_cfgspace.sh [-keep_index]\n\
Usage: bram_pcie_cfgspace.sh [-noclean_files]\n\n\
